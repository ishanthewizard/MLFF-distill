"""Config: MSD/diffusivity for all OPLS NVT production systems.

Walks .../simulation_results/OPLS/nvt/<salt>_<solvent>_<conc>M_<temp>K/
(GROMACS nvt.xtc + nvt.tpr, dt=1 fs, frames every 1 ps -> dt_fs=1000) and
...
# NOTE: using local pscratch copies of nvt.xtc/nvt.tpr -- flock() used by
# MDAnalysis's offset cache hangs indefinitely on the CFS filesystem.
_ROOT = Path("/pscratch/sd/y/yuejian/opls_nvt_local")
...
OUTPUT_DIR = "/global/homes/y/yuejian/project/MLFF-distill/yuejian/electrolyte_application/analysis/opls_nvt_msd"
ANALYSES   = ["msd"]
