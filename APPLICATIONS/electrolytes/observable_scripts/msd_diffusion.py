...
solvents = ["dme", "dme"]
distilled_trajs = ["/home/yuejian/project/MLFF-distill/OMOL/electrolytes_application/ablate_distillation/10ns_intermediate/md_omol_naotf_dme_s1p1_omol_10/md_omol_naotf_dme_s1p1_omol_10.traj",
...
# Output root
out_dir = Path("/home/yuejian/project/MLFF-distill/OMOL/electrolytes_application/ablate_distillation/msd/intermediate_analysis/"+f"{analyze_first_n_frames}")
