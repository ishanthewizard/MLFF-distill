"""Config: MSD analysis for omol NaPF6/DME 0.1M 298K — full 20 ns.
...
SYSTEMS = [
    {
        "name":           "NaPF6/DME 0.1M 298K (omol, 20ns)",
...
OUTPUT_DIR = (
    "/global/homes/y/yuejian/project/MLFF-distill"
    "/yuejian/electrolyte_application/analysis/msd_omol_napf6_dme_0p1M_298K_20ns"
)
ANALYSES = ["msd"]
WORKERS  = 1
