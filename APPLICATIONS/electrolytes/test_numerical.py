...
def print_torch_precision_info() -> None:
    """Print torch TF32/matmul precision settings for reproducibility."""
    print("=== Torch precision settings ===")
