...
def simulate(root_path, rank=None, world_size=None, interval=50, total_target_steps=1000000, model_checkpoint=None):
    ...
    try:
        ...
        existing_simulated_steps = len(all_frames)
    except Exception as e:
...
if __name__ == "__main__":
    # === Configuration ===
    total_target_steps = 10000000 # 10ns
    interval = 50  # for a single traj, make it fixed across the simulation
    model_checkpoint = "/global/homes/y/yuejian/project/MLFF-distill/logs/naotf-202509-0220-1938-d9be/checkpoints/final/inference_ckpt.pt"
    ...
    # === Trajectory setup ===
    # Example: Multiple trajectories for different solvents
    trajectory_paths = [
        "/global/homes/y/yuejian/project/MLFF-distill/m4558/md_simulation_copy/naotf/md_omol_naotf_diglyme_1m_s1p1",
        "/global/homes/y/yuejian/project/MLFF-distill/m4558/md_simulation_copy/naotf/md_omol_naotf_dme_s1p1_omol",
        "/global/homes/y/yuejian/project/MLFF-distill/m4558/md_simulation_copy/naotf/md_omol_naotf_pc_1m_s1p1"
    ]
