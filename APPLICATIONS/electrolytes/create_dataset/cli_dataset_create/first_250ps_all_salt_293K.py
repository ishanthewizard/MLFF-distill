#!/usr/bin/env python3
"""Create first 250ps dataset for all 15 salt systems (293K).
...
2. Run the script:
       python first_250ps_all_salt_293K.py
3. The script will:
...
# Output paths
# -----------------------------------------------------------------------------
output_root = '/global/homes/y/yuejian/project/MLFF-distill/m5024/distillation_project/data/lmdb_for_distillation/all_salt_first_250ps'
