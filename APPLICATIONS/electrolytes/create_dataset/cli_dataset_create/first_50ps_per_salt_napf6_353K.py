#!/usr/bin/env python3
"""Create first 50ps dataset for napf6/dme systems only (353K).
...
2. Run the script:
       python first_50ps_per_salt_napf6_353K.py
3. The script will:
   - Subsample ASE .traj files from 353K (first WINDOW_SIZE frames per traj)
...
# Output paths
# -----------------------------------------------------------------------------
output_root = '/pscratch/sd/y/yuejian/baseline/napf6_first_50ps_353K'
...
# Input trajectories
# -----------------------------------------------------------------------------
# napf6/dme at 3 concentrations from 353K simulations
input_trajs = [
    "/global/homes/y/yuejian/project/MLFF-distill/m5024/distillation_project/data/raw_data_from_UMA_simulation/353K/all_systems_all_concentration/1M/napf6_dme/napf6_dme.traj",
    "/global/homes/y/yuejian/project/MLFF-distill/m5024/distillation_project/data/raw_data_from_UMA_simulation/353K/all_systems_all_concentration/0.5M/md_omol_napf6_dme_re1/md_omol_napf6_dme_re1.traj",
    "/global/homes/y/yuejian/project/MLFF-distill/m5024/distillation_project/data/raw_data_from_UMA_simulation/353K/all_systems_all_concentration/0.1M/md_omol_napf6_dme_re1/md_omol_napf6_dme_re1.traj",
]
