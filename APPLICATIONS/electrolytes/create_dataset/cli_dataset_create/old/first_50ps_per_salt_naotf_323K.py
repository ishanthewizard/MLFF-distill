#!/usr/bin/env python3
"""Create first 50ps dataset for naotf systems only (323K).
...
2. Run the script:
       python first_50ps_per_salt_naotf_323K.py
3. The script will:
...
# Output paths
# -----------------------------------------------------------------------------
output_root = '/global/homes/y/yuejian/project/MLFF-distill/m5024/distillation_project/data/lmdb_for_distillation/per_salt_first_50ps_remake/naotf_first_50ps_323K'
...
# NOTE: Directory containing naotf .traj files (323K 500ps simulations)

input_trajs = [
    # NOTE: All naotf trajectories in 323K_500ps_trajs (diglyme, dme, pc, tgdme)
    f'{RAW_DATA_ROOT}/md_omol_naotf_diglyme_1m_s1p1/md_omol_naotf_diglyme_1m_s1p1.traj',
    f'{RAW_DATA_ROOT}/md_omol_naotf_dme_s1p1_omol/md_omol_naotf_dme_s1p1_omol.traj',
    f'{RAW_DATA_ROOT}/md_omol_naotf_pc_1m_s1p1/md_omol_naotf_pc_1m_s1p1.traj',
    f'{RAW_DATA_ROOT}/md_omol_naotf_tgdme_1m_s1p1/md_omol_naotf_tgdme_1m_s1p1.traj',
]
