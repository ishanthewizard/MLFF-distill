...
def main(args: argparse.Namespace):
    ...
    dataloader = Dataloader(args.transition1x_h5, datasplit=args.split, subgroup=args.subgroup, trajectory_subset=args.trajectory_subset, frac_neb_iterations = args.frac_neb_iterations)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        choices=["", "reactant", "product", "transition_state"],
        help="Subgroup to filter when reading the HDF5 file.",
    )
    parser.add_argument(
        "--trajectory_subset",
        type=int,
        nargs=2,
        help="Subset of trajectories to extract. Start and end indices, e.g. 3 5 extracts indices 3, 4, 5 from the trajectory .",
        default=None,
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Fraction of NEB iterations to keep, working backwards from convergence. E.g. 0.2 keeps the last 20 percent of NEB iterations.",
    )
