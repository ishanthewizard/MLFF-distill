...
def convert_labels(labels_folder, new_labels_folder, model="medium"):
    ...
    force_jac_idxs_dataset = LmdbHessianIndexDataset(os.path.join(labels_folder,  'force_jacobians'), div_2=True)
    ...
    record_and_save(force_jac_idxs_dataset, os.path.join(new_labels_folder, 'force_jacobians', 'force_jacobians.lmdb'), identity, is_idxs=True)

if __name__ == "__main__":
    # labels_folder = 'labels/mace_off_large_Perovskites'
    labels_folder = '/data/ishan-amin/OMOL/electrolytes_application/labels/NAPF6/s1p1'
    # labels_folder = '/data/ericqu/EScAIP_labels/iodine'
    new_labels_folder = '/data/ishan-amin/OMOL/electrolytes_application/labels/NAPF6/s1p1_DENORMED'
