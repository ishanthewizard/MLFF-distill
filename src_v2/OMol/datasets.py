...
class AseAtomsDataset_io(BaseDataset, ABC):
    """
    ...
    def __getitem__(self, idx):
        ...
        atoms,atoms_row = self.get_atoms(self.ids[idx])
...
@registry.register_dataset("ase_db_io")
class AseDBDataset_io(AseAtomsDataset_io):
    """
