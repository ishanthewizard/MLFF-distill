...
#SBATCH --job-name=uma_teacher_naotf_dme
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/Mar_19/uma_on_0_5_0_1_boxes/20ns_solvent_0_1M/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1"
)
TEMPERATURES=(293.0)
INITIAL_TEMPERATURES=(293.0)
TARGET_STEPS=100000
INTERVAL=10
