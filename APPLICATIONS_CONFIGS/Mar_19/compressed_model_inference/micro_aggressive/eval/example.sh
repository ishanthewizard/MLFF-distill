...
#
# Usage:
#   sbatch msd_100ps_0_1M_md_omol_naotf_pc_1m_s1p1_298_2K.sh
#
...
# === All systems under 20ns_solute_solvent_1M ===
BASE="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/Mar_19/faster_student/micro_aggressive/20ns_solute_solvent_1M"
MSD_TARGETS_JSON='[
    ["'"$BASE"'/md_omol_napf6_diglyme_pfactor_0.1_1fs/md_omol_napf6_diglyme_pfactor_0.1_1fs.traj", "md_omol_napf6_diglyme_pfactor_0.1_1fs_298_2K", "Na", "PF6", "Diglyme", "1M", "298_2K"],
    ["'"$BASE"'/naotf_diglyme/naotf_diglyme.traj", "naotf_diglyme_298_2K", "Na", "OTf", "Diglyme", "1M", "298_2K"],
    ["'"$BASE"'/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1.traj", "md_omol_napf6_pc_pfactor_0.1_1fs_mask_t_s1p1_298_2K", "Na", "PF6", "PC", "1M", "298_2K"],
    ["'"$BASE"'/napf6_dme/napf6_dme.traj", "napf6_dme_298_2K", "Na", "PF6", "DME", "1M", "298_2K"],
    ["'"$BASE"'/naotf_dme/naotf_dme.traj", "naotf_dme_298_2K", "Na", "OTf", "DME", "1M", "298_2K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/Mar_19/faster_student/micro_aggressive/eval"

# Set tau_max_fit_ps to 20000 ps (20 ns)
TAU_MAX_FIT_PS=11000
