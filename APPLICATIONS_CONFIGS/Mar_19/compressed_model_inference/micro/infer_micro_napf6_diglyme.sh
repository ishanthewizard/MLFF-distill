...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/Mar_19/faster_student/micro/20ns_solute_solvent_1M/md_omol_napf6_diglyme_pfactor_0.1_1fs"
)
TEMPERATURES=(298.0)
