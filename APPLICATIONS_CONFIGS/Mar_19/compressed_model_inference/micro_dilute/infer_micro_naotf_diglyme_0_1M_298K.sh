...
#SBATCH --job-name=micro_infer_naotf_diglyme
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/Mar_19/faster_student/micro_dilute/20ns_solvent_0_1M/298K/md_omol_naotf_diglyme_1m_s1p1"
)
TEMPERATURES=(298.0)
