...
#SBATCH --job-name=temp_ablation_20ns_solvent_solute_0.5M-298_2K-md_omol_napf6_dme_re1
...
# === Configuration ===
MODEL_CHECKPOINTS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/ckpt/202603-0519-4138-75e9-first500ps_all_salts_293K_same_amount_of_data_to50ps/final/inference_ckpt.pt"
)
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_and_all_sys_ablation_Mar_13_2026/500ps_same_data/initial_box/20ns_solvent_solute_0.5M/298_2K/md_omol_napf6_dme_re1"
)
TEMPERATURES=(298.2)
INITIAL_TEMPERATURES=(298.2)
