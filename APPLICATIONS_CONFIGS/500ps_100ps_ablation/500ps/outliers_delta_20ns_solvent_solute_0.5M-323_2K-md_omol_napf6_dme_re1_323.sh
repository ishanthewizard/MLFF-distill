...
#SBATCH --job-name=temp_ablation_20ns_solvent_solute_0.5M-323_2K-md_omol_napf6_dme_re1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_and_all_sys_ablation_Mar_13_2026/500ps_same_data/initial_box/20ns_solvent_solute_0.5M/323_2K/md_omol_napf6_dme_re1"
)
TEMPERATURES=(323.2)
