...
MSD_TARGETS_JSON='[
    ["'"$BASE"'/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1.traj", "md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1", "Na", "PF6", "PC", "1M", "298_2K"]
]'
