...
#
# Usage:
#   sbatch msd_100ps_1M_naotf_dme_298_2K.sh
#
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_and_all_sys_ablation_Mar_13_2026/100ps_double_data/initial_box/20ns_solute_solvent_1M/naotf_dme/naotf_dme.traj", "naotf_dme_298_2K", "Na", "OTf", "DME", "1M", "298_2K"]
]'
