...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_and_all_sys_ablation_Mar_13_2026/100ps_double_data/initial_box/20ns_solvent_0_1M/md_omol_naotf_pc_1m_s1p1/md_omol_naotf_pc_1m_s1p1.traj", "md_omol_naotf_pc_1m_s1p1_298_2K", "Na", "OTf", "PC", "0_1M", "298_2K"]
]'
