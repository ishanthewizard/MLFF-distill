...
#
# Usage:
#   sbatch msd_100ps_0_1M_md_omol_napf6_propylene_carbonate_pfactor_0_1_1fs.sh
#
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_and_all_sys_ablation_Mar_13_2026/100ps_double_data/initial_box/20ns_solvent_0_1M/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1.traj", "md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1_298_2K", "Na", "PF6", "PC", "0_1M", "298_2K"]
]'
