...
#SBATCH --job-name=temp_ablation_20ns_solvent_solute_0.5M-298_2K-md_omol_lipf6_pfactor_0.1_1fs_mask_t
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/temp_ablation/initial_box_inference_md_323K/20ns_solvent_solute_0.5M/298_2K/md_omol_lipf6_pfactor_0.1_1fs_mask_t"
)
TEMPERATURES=(298.2)
