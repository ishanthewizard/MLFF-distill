...
#SBATCH --job-name=temp_ablation_20ns_solvent_solute_0.5M-273_2K-md_omol_napf6_dme_re1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/temp_ablation/initial_box_inference_md_323K/20ns_solvent_solute_0.5M/273_2K/md_omol_napf6_dme_re1"
)
TEMPERATURES=(273.2)
