...
#SBATCH --job-name=temp_ablation_20ns_solute_solvent_1M-naotf_dme
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/temp_ablation/initial_box_inference_md_323K/20ns_solute_solvent_1M/naotf_dme"
)
TEMPERATURES=(298.0)
