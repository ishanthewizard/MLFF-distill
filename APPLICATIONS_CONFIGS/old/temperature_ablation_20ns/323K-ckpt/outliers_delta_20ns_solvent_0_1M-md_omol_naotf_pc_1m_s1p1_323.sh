...
#SBATCH --job-name=temp_ablation_20ns_solvent_0_1M-md_omol_naotf_pc_1m_s1p1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/temp_ablation/initial_box_inference_md_323K/20ns_solvent_0_1M/md_omol_naotf_pc_1m_s1p1"
)
TEMPERATURES=(298.0)
