...
# === Configuration ===
MODEL_CHECKPOINTS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/ckpt_over_all/step_21000/inference_ckpt.pt"
)
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/speed/naotf_dme"
)
TEMPERATURES=(298.0)
