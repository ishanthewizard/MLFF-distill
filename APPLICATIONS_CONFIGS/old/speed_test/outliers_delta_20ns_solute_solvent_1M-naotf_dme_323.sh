...
# === Configuration ===
MODEL_CHECKPOINTS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/ckpt/intermediate/step_129000/inference_ckpt.pt"
)
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/speed/20ns_solute_solvent_1M/naotf_dme"
)
TEMPERATURES=(298.0)
