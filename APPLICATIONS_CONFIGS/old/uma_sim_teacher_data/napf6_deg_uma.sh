...
#SBATCH --job-name=uma_teacher_napf6_deg
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/generating_teacher_dataset/initial_boxes_for_UMA/napf6_deg"
)
TEMPERATURES=(353.0)
