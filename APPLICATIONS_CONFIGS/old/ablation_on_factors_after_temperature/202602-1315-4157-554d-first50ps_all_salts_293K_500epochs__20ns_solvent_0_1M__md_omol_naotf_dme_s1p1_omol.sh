...
#SBATCH --job-name=202602-1315-4157-554d-first50ps_all_salts_293K_500epochs__20ns_solvent_0_1M__md_omol_naotf_dme_s1p1_omol
...
# === Configuration ===
MODEL_CHECKPOINTS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/ckpt/202602-1315-4157-554d-first50ps_all_salts_293K_500epochs/final/inference_ckpt.pt"
)

TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_all_salts_teacher_data_293K_500epochs/20ns_solvent_0_1M/md_omol_naotf_dme_s1p1_omol"
)
