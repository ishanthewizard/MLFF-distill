...
#
# Usage:
#   sbatch msd_100ps_all_salts_293K_napf6_dme_0_1M_298K.sh
#
...
#SBATCH --time=1:00:00
#SBATCH --job-name=msd_100ps_all_salts_293K_napf6_dme_0_1M_298K
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_100ps_all_salts_teacher_data_293K/20ns_solvent_0_1M/md_omol_napf6_dme_re1/md_omol_napf6_dme_re1.traj", "100ps_all_salts_293K_napf6_dme_0_1M_298K", "Na", "PF6", "DME", "0_1M", "298K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/analysis/first_100ps_all_salts_teacher_data_293K/md_omol_napf6_dme_re1_0_1M_298K"

# Set tau_max_fit_ps to 6000 ps (6 ns)
TAU_MAX_FIT_PS=12000
