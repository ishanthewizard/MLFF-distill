...
#
# Usage:
#   sbatch msd_100ps_all_salts_293K_napf6_dme_0_5M_323_2K.sh
#
...
#SBATCH --time=1:00:00
#SBATCH --job-name=msd_100ps_all_salts_293K_napf6_dme_0_5M_323_2K
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_100ps_all_salts_teacher_data_293K/20ns_solvent_solute_0.5M/323_2K/md_omol_napf6_dme_re1/md_omol_napf6_dme_re1.traj", "100ps_all_salts_293K_napf6_dme_0_5M_323_2K", "Na", "PF6", "DME", "0_5M", "323_2K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/analysis/first_100ps_all_salts_teacher_data_293K/md_omol_napf6_dme_re1_0_5M_323_2K"

# Set tau_max_fit_ps to 4000 ps (4 ns)
