...
#SBATCH --time=1:00:00
#SBATCH --job-name=msd_50ps_all_salts_293K_500ep_naotf_dme_0_1M_298K
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_all_salts_teacher_data_293K_500epochs/20ns_solvent_0_1M/md_omol_naotf_dme_s1p1_omol/md_omol_naotf_dme_s1p1_omol.traj", "50ps_all_salts_293K_500ep_naotf_dme_0_1M_298K", "Na", "OTf", "DME", "0_1M", "298K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/analysis/first_50ps_all_salts_teacher_data_293K_500epochs/md_omol_naotf_dme_s1p1_omol_0_1M_298K"
