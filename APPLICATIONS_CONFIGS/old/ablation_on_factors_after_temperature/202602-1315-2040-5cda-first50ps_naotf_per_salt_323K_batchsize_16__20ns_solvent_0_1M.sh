...
#SBATCH --job-name=202602-1315-2040-5cda-first50ps_naotf_per_salt_323K_batchsize_16__20ns_solvent_0_1M
...
# === Configuration ===
MODEL_CHECKPOINT="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/ckpt/202602-1315-2040-5cda-first50ps_naotf_per_salt_323K_batchsize_16/final/inference_ckpt.pt"
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_naotf_per_salt_teacher_data_323K_batchsize_16/20ns_solvent_0_1M/md_omol_naotf_dme_s1p1_omol"
)
