...
#SBATCH --job-name=202602-1315-1942-821a-first100ps_all_salts_293K__20ns_solvent_0_1M__md_omol_napf6_dme_re1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_100ps_all_salts_teacher_data_293K/20ns_solvent_0_1M/md_omol_napf6_dme_re1"
)
