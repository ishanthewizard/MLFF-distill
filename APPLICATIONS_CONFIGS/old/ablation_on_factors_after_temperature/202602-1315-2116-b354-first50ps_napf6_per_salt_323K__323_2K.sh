...
#SBATCH --job-name=202602-1315-2116-b354-first50ps_napf6_per_salt_323K__323_2K
...
# === Configuration ===
MODEL_CHECKPOINT="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/ckpt/202602-1315-2116-b354-first50ps_napf6_per_salt_323K/final/inference_ckpt.pt"
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_napf6_dme_per_salt_teacher_data_323K/20ns_solvent_solute_0.5M/323_2K/md_omol_napf6_dme_re1"
)

TEMPERATURE=323.2
INITIAL_TEMPERATURE=323.2
