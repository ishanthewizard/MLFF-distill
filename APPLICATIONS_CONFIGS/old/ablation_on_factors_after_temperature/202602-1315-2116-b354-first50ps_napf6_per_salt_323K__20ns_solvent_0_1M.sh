...
#SBATCH --job-name=202602-1315-2116-b354-first50ps_napf6_per_salt_323K__20ns_solvent_0_1M
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_napf6_dme_per_salt_teacher_data_323K/20ns_solvent_0_1M/md_omol_napf6_dme_re1"
)
