...
#SBATCH --job-name=202602-1901-3913-6abe-first50ps_naotf_per_salt_323K_batch_size_8__20ns_solvent_0_1M__md_omol_naotf_dme_s1p1_omol
...
# === Configuration ===
MODEL_CHECKPOINTS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/ckpt/202602-1901-3913-6abe-first50ps_naotf_per_salt_323K_batch_size_8/final/inference_ckpt.pt"
)

TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_naotf_per_salt_teacher_data_323K_batchsize_8/20ns_solvent_0_1M/md_omol_naotf_dme_s1p1_omol"
)
