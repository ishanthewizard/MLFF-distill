...
#SBATCH --job-name=202602-1315-4157-554d-first50ps_all_salts_293K_500epochs__323_2K__md_omol_napf6_dme_re1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_all_salts_teacher_data_293K_500epochs/20ns_solvent_solute_0.5M/323_2K/md_omol_napf6_dme_re1"
)
