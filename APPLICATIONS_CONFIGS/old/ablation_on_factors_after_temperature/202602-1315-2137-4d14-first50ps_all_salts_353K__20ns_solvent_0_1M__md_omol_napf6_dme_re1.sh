...
#SBATCH --job-name=202602-1315-2137-4d14-first50ps_all_salts_353K__20ns_solvent_0_1M__md_omol_napf6_dme_re1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Feb_2026/md_simulation/first_50ps_all_salts_teacher_data_353K/20ns_solvent_0_1M/md_omol_napf6_dme_re1"
)
