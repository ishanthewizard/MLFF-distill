...
#
# Usage:
#   sbatch msd_50ps_all_salts_293K_500ep_md_omol_lipf6_dme_0_5M_298_2K.sh
#
...
#SBATCH --time=1:00:00
#SBATCH --job-name=msd_uma_1ns_lipf6_dme_0_5M_298_2K_md_omol
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Mar_2026/uma_1ns/20ns_solvent_solute_0.5M/298_2K/md_omol_lipf6_pfactor_0.1_1fs_mask_t/md_omol_lipf6_pfactor_0.1_1fs_mask_t.traj", "uma_1ns_lipf6_dme_0_5M_298_2K_md_omol", "Li", "PF6", "DME", "0_5M", "298_2K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Mar_2026/uma_1ns/analysis/msd_uma_1ns_lipf6_dme_0_5M_298_2K_md_omol"
