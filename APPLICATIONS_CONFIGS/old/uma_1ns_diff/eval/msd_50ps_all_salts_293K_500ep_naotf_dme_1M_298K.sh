...
#
# Usage:
#   sbatch msd_50ps_all_salts_293K_500ep_naotf_dme_0_1M_298K.sh
#
...
#SBATCH --time=1:00:00
#SBATCH --job-name=msd_uma_1ns_naotf_dme_0_1M_298K
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Mar_2026/uma_1ns/20ns_solute_solvent_1M/naotf_dme/naotf_dme.traj", "uma_1ns_naotf_dme_0_1M_298K", "Na", "OTf", "DME", "1M", "298K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Mar_2026/uma_1ns/analysis/msd_uma_1ns_naotf_dme_1M_298K"
