...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/outlier_ablation_Mar_2026/uma_1ns/20ns_solute_solvent_1M/naotf_dme"
)
TEMPERATURES=(298.0)
