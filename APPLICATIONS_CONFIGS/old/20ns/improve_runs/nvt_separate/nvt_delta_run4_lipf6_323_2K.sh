...
#SBATCH --job-name=mlff_nvt_20ns_run4_lipf6_323
...
#        "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/ablation_diffusivity/nvt_unstable/20ns_solvent_solute_0.5M/323_2K/md_omol_lipf6_pfactor_0.1_1fs_mask_t" \
#        --models \
