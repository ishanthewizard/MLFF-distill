...
#SBATCH --job-name=mlff_nvt_20ns_run3_napf6_298
...
#        "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/ablation_diffusivity/nvt_unstable/20ns_solvent_solute_0.5M/298_2K/md_omol_napf6_dme_re1" \
#        --models \
