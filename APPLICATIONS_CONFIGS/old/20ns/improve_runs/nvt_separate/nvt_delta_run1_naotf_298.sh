...
#SBATCH --job-name=mlff_nvt_20ns_run1_naotf
...
#      --time=00:05:00 --mem=64g \
#      --pty bash -lc 'cd /u/yjian1/project/MLFF-distill && \
#      python -u APPLICATIONS/electrolytes/solv_uma_nvt_flex_ablation.py \
#        "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/ablation_diffusivity/nvt_unstable/20ns_solvent_0_1M/md_omol_naotf_dme_s1p1_omol" \
#        --models \
