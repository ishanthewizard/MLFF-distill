...
#SBATCH --job-name=mlff_nvt_20ns_run5_napf6_323
...
srun --partition=ghx4 --account=bfoy-dtai-gh \
     ...
     python -u APPLICATIONS/electrolytes/solv_uma_nvt_flex_ablation.py \
       "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/ablation_diffusivity/nvt_unstable/20ns_solvent_solute_0.5M/323_2K/md_omol_napf6_dme_re1" \
       --models \
