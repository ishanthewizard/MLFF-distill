...
#SBATCH --job-name=mlff_nvt_debug_naotf
...
srun --account=bfoy-dtai-gh \
     ...
     python -u APPLICATIONS/electrolytes/solv_uma_nvt_flex_ablation.py \
       "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/ablation_diffusivity/debug/md_omol_naotf_dme_s1p1_omol" \
       --models \
...
#
# === Local Debug (no Slurm, run directly on a node/login with GPU) ===
# cd /u/yjian1/project/MLFF-distill && \
python -u APPLICATIONS/electrolytes/solv_uma_nvt_flex_ablation.py \
  "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/ablation_diffusivity/debug/md_omol_naotf_dme_s1p1_omol" \
  --models "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/models_copy_from_nersc/Ishan_all_salt_wo_hessian/final/inference_ckpt.pt" \
  --steps 20000000 --interval 100 \
  --temperature 298.0 \
  --initial_temperature 298.0
#
