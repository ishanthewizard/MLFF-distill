...
#SBATCH --job-name=mlff_outliers_20ns_run5
...
#        "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/ablation_diffusivity/outliers/20ns_solvent_0.1M/md_omol_napf6_dme_re1" \
#        --models \
