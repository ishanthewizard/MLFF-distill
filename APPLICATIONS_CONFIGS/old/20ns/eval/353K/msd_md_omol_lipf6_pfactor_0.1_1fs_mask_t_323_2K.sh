...
#
# Usage:
#   sbatch msd_md_omol_lipf6_pfactor_0.1_1fs_mask_t_323_2K.sh
#
...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/ablate_temperature_whole_exp/temp_ablation/initial_box_inference_md_353K/20ns_solvent_solute_0.5M/323_2K/md_omol_lipf6_pfactor_0.1_1fs_mask_t/md_omol_lipf6_pfactor_0.1_1fs_mask_t.traj", "md_omol_lipf6_pfactor_0.1_1fs_mask_t_323_2K", "Li", "PF6", "DME", "0_5M", "323_2K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/analysis/2_3/353/md_omol_lipf6_pfactor_0.1_1fs_mask_t_323_2K"
