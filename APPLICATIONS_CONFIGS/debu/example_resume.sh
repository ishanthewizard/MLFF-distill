...
# === Configuration ===
MODEL_CHECKPOINTS=(
    "/u/yjian1/project/MLFF-distill/runs/202604-1401-1406-ddd3/checkpoints/step_180/inference_ckpt.pt"
)
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/speed_test/naotf_dme"
)
TEMPERATURES=(298.0)
INITIAL_TEMPERATURES=(298.0)
TARGET_STEPS=20000000
INTERVAL=100
# MD timestep (femtoseconds); passed to solv_uma_npt_flex_ablation.py as --timestep
dt=1
