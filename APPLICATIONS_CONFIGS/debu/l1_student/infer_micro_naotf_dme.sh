...
# === Configuration ===
MODEL_CHECKPOINTS=(
    "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/compression_logs/202604-0114-1000-6612/checkpoints/step_23000/inference_ckpt.pt"
)
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/MLFF-distill/debug/speed/micro_l1/naotf_dme"
)
TEMPERATURES=(298.0)
