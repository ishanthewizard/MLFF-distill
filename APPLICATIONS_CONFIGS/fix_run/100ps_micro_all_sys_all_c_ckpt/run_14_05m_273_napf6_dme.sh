...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/micro_100ps_all_sys_all_c_student/20ns_solvent_solute_0.5M/273_2K/md_omol_napf6_dme_re1"
)
TEMPERATURES=(273.2)
...
CMD=(python -u APPLICATIONS/elect rolytes/solv_uma_npt_flex_ablation_resume.py)
CMD+=("${TRAJECTORY_DIRS[@]}")
