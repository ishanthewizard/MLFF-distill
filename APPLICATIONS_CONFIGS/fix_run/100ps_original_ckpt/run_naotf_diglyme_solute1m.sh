...
#SBATCH --job-name=fix_original_naotf_dgly_1m
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/origin_100ps_student/20ns_solute_solvent_1M/298K/naotf_diglyme"
)
TEMPERATURES=(298.0)
