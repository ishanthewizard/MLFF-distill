...
#SBATCH --job-name=fix_original_napf6_dme_r1_298
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/origin_100ps_student/20ns_solvent_solute_0.5M/298_2K/md_omol_napf6_dme_re1"
)
TEMPERATURES=(298.2)
