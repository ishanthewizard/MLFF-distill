...
#SBATCH --job-name=fix_original_naotf_tgdme_s1p1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/origin_100ps_student/20ns_solvent_0_1M/298K/md_omol_naotf_tgdme_1m_s1p1"
)
TEMPERATURES=(298.0)
