...
#SBATCH --job-name=fix_micro_napf6_dme_r1_323
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/micro_100ps_student/20ns_solvent_solute_0.5M/323_2K/md_omol_napf6_dme_re1"
)
TEMPERATURES=(323.2)
