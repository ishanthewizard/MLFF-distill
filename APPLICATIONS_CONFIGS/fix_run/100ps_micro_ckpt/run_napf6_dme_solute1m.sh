...
#SBATCH --job-name=fix_micro_napf6_dme_1m
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/micro_100ps_student/20ns_solute_solvent_1M/298K/napf6_dme"
)
TEMPERATURES=(298.0)
