...
#SBATCH --job-name=fix_micro_napf6_pc_pf01_s1p1
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/micro_100ps_student/20ns_solvent_0_1M/298K/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1"
)
TEMPERATURES=(298.0)
