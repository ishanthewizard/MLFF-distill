...
#SBATCH --job-name=fix_micro_napf6_dgly_pf01_1fs_1m
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/micro_100ps_student/20ns_solute_solvent_1M/298K/md_omol_napf6_diglyme_pfactor_0.1_1fs"
)
TEMPERATURES=(298.0)
