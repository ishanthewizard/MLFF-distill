...
#SBATCH --job-name=fix_micro_lipf6_298p2_05m
...
TRAJECTORY_DIRS=(
    "/u/yjian1/project/MLFF-distill/yjian1/electrolyte_application/fix_run/micro_100ps_student/20ns_solvent_solute_0.5M/298_2K/md_omol_lipf6_pfactor_0.1_1fs_mask_t"
)
TEMPERATURES=(298.2)
