...
#SBATCH --job-name=md_sanity_300          # Name of the job (shows in queue)
...
#SBATCH --qos=premium                  # Quality of service (debug queue for testing)
#SBATCH --time=1:00:00                 # Maximum runtime: 5 minutes for testing
...
TRAJECTORY_DIRS=(
    ...
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/sanity_check_at_300/md_omol_naotf_diglyme_1m_s1p1"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/sanity_check_at_300/md_omol_naotf_dme_s1p1_omol"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/sanity_check_at_300/md_omol_naotf_pc_1m_s1p1"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/sanity_check_at_300/md_omol_naotf_tgdme_1m_s1p1"
)
...
CMD="python APPLICATIONS/electrolytes/solv_uma_npt_pr_requeue_2_sanity.py"
