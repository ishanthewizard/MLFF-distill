...
#SBATCH --job-name=md_2          # Name of the job (shows in queue)
...
TRAJECTORY_DIRS=(
    ...
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/MD_data_rest_queue_2/md_omol_naotf_diglyme_1m_s1p1"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/MD_data_rest_queue_2/md_omol_naotf_dme_s1p1_omol"
    # group 2
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/MD_data_rest_queue_2/md_omol_naotf_pc_1m_s1p1"
