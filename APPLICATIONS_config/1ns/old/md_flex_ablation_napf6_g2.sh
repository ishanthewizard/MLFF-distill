...
#SBATCH --job-name=2_napf6    # Name of the job (shows in queue)
...
TRAJECTORY_DIRS=(
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/napf6/md_omol_napf6_dme_re1_wo_hessian"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/napf6/md_omol_napf6_dme_re1_w_hessian"
)
