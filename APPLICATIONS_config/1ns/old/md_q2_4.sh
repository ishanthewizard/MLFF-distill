...
#SBATCH --job-name=md_4          # Name of the job (shows in queue)
...
TRAJECTORY_DIRS=(
    ...
    # group 4
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/MD_data_rest_queue_2/md_omol_natfsi_dme_s1p1"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/MD_data_rest_queue_2/md_omol_napf6_tgdme_1m_s1p1"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/MD_data_rest_queue_2/md_omol_napf6_tgdme_1m_s1p1_re2"
)
