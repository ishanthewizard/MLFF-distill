...
#SBATCH --job-name=fl1    # Name of the job (shows in queue)
...
MODEL_CHECKPOINTS=(
    ...
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/small_batch/202510-1714-3239-2d8b-naotf-20/cleaned_inference_ckpt.pt"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/small_batch/202510-1714-3305-c9b6-naotf-50/cleaned_inference_ckpt.pt"
)

# Trajectory directories (space-separated list, same length as models)
TRAJECTORY_DIRS=(
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/ablate_cols/md_omol_naotf_pc_1m_s1p1_wo_hessian"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/ablate_cols/md_omol_naotf_pc_1m_s1p1_10"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/ablate_cols/md_omol_naotf_pc_1m_s1p1_20"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/ablate_cols/md_omol_naotf_pc_1m_s1p1_50"
)
