...
#SBATCH --job-name=napf6    # Name of the job (shows in queue)
...
MODEL_CHECKPOINTS=(
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/small_batch/202510-2322-2657-3d7e-napf6-wo/checkpoints/final/inference_ckpt.pt"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/small_batch/202510-2322-2657-3d7e-napf6-wo/checkpoints/final/inference_ckpt.pt"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/small_batch/202510-2322-2744-5337-napf6-10/cleaned_inference_ckpt.pt"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/small_batch/202510-2322-2744-5337-napf6-10/cleaned_inference_ckpt.pt"
)

# Trajectory directories (space-separated list, same length as models)
TRAJECTORY_DIRS=(
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/napf6/md_omol_napf6_diethyleneglycol_pfactor_0.1_1fs_mask_t_wo_hessian"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/napf6/md_omol_napf6_tgdme_1m_s1p1_wo_hessian"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/napf6/md_omol_napf6_diethyleneglycol_pfactor_0.1_1fs_mask_t_w_hessian"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/ablation_section_3/napf6/md_omol_napf6_tgdme_1m_s1p1_w_hessian"
)
