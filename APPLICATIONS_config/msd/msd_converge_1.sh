...
#SBATCH --job-name=msd_convergence_1    # Name of the job (shows in queue)
...
OUT_DIR="/global/homes/y/yuejian/project/MLFF-distill/yuejian/electrolyte_application/ablate_distillation/observables/msd/converge_12_6/20ns_batch_1"

# Set tau_max_fit_ps to 20000 (20 ns) - fixed value
TAU_MAX_FIT_PS=20000 # 20000
# ====end of user config====
