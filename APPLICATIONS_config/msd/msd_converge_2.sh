...
#SBATCH --job-name=msd_convergence_2    # Name of the job (shows in queue)
...
OUT_DIR="/global/homes/y/yuejian/project/MLFF-distill/yuejian/electrolyte_application/ablate_distillation/observables/msd/converge_12_6/20ns_batch_2"
