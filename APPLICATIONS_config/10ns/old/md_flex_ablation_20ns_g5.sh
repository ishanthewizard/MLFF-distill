...
#SBATCH --job-name=g5_t2_1M    # Name of the job (shows in queue)
...
TRAJECTORY_DIRS=(
    ...
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/electrolyte_application/ablate_distillation/ablation_diffusivity/20ns_solute_solvent_1M/md_omol_napf6_diglyme_pfactor_0.1_1fs"
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/electrolyte_application/ablate_distillation/ablation_diffusivity/20ns_solute_solvent_1M/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1"
)
