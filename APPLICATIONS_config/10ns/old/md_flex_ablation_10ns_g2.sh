...
#SBATCH --cpus-per-task=16              # 5 CPU cores per task (for each GPU)
...
MODEL_CHECKPOINTS=(
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/Ishan_all_salt_wo_hessian/final/inference_ckpt.pt"
    # "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablation_ckpt/Ishan_all_salt_wo_hessian/final/inference_ckpt.pt"
...
TRAJECTORY_DIRS=(
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/10ns_solvent_0_1M/md_omol_napf6_diglyme_pfactor_0.1_1fs"
    # "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/10ns_solvent_0_1M/md_omol_napf6_propylene_carbonate_pfactor_0.1_1fs_mask_t_s1p1"
    # "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/10ns_lipf6/md_omol_lipf6_pfactor_0.1_1fs_mask_t_wo_hessian"
    # "/global/homes/y/yuejian/project/MLFF-distill/yuejian/OMOL/electrolyte_application/ablate_distillation/10ns_lipf6/md_omol_lipf6_pfactor_0.1_1fs_mask_t_w_hessian"
)

# Simulation parameters
TARGET_STEPS=10000000    # Total MD steps (10 ns at 1 fs timestep)
INTERVAL=10            # Output interval for trajectory and status
TEMPERATURE=298        # Simulation temperature (K)
INITIAL_TEMPERATURE=298 # Initial temperature (K)
