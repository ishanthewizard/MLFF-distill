...
#SBATCH --job-name=g7_nvt_10ns         # Job name
...
TRAJECTORY_DIRS=(
    "/global/homes/y/yuejian/project/MLFF-distill/yuejian/electrolyte_application/ablate_distillation/ablation_diffusivity/outlier_patches_1st_frame/20ns_solvent_0_1M/md_omol_napf6_dme_re1"
)
