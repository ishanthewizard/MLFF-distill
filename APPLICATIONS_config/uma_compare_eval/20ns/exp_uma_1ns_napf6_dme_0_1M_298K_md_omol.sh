...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/global/homes/y/yuejian/project/MLFF-distill/m5250/electrolyte_application/ablate_distillation/ablation_diffusivity/20ns_solvent_0_1M/md_omol_napf6_dme_re1/md_omol_napf6_dme_re1.traj", "uma_1ns_napf6_dme_0_1M_298K_md_omol", "Na", "PF6", "DME", "0_1M", "298K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/global/homes/y/yuejian/project/MLFF-distill/m5250/electrolyte_application/analysis/20ns/msd_uma_1ns_napf6_dme_0_1M_298K_md_omol"
