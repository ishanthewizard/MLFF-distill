...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/global/homes/y/yuejian/project/MLFF-distill/m5250/electrolyte_application/ablate_distillation/ablation_diffusivity/20ns_solvent_solute_0.5M/298_2K/md_omol_lipf6_pfactor_0.1_1fs_mask_t/md_omol_lipf6_pfactor_0.1_1fs_mask_t.traj", "uma_1ns_lipf6_dme_0_5M_298_2K_md_omol", "Li", "PF6", "DME", "0_5M", "298_2K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/global/homes/y/yuejian/project/MLFF-distill/m5250/electrolyte_application/analysis/10ns/msd_uma_1ns_lipf6_dme_0_5M_298_2K_md_omol"
