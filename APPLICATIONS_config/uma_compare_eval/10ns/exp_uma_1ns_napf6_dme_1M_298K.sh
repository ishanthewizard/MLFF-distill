...
# === Single target ===
MSD_TARGETS_JSON='[
    ["/global/homes/y/yuejian/project/MLFF-distill/m5250/electrolyte_application/ablate_distillation/ablation_diffusivity/20ns_solute_solvent_1M/napf6_dme/napf6_dme.traj", "uma_1ns_napf6_dme_1M_298K", "Na", "PF6", "DME", "1M", "298K"]
]'

export MSD_TARGETS_JSON

# Output directory (isolated per system to allow parallel runs)
OUT_DIR="/global/homes/y/yuejian/project/MLFF-distill/m5250/electrolyte_application/analysis/10ns/msd_uma_1ns_napf6_dme_1M_298K"
