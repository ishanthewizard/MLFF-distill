...
if __name__ == "__main__":
    ...
    parser.add_argument("--init_data_idx", type=int, default=10)
    ...
    for i, mol in enumerate(tqdm(molecules)):
        ...
        forces.append(force)
        engs.append(energy)
        with open(os.path.join(traj_path, f'dft_energies_system{idx}.pkl'), 'wb') as f:
            pickle.dump(engs, f)
        with open(os.path.join(traj_path, f'dft_forces_system{idx}.pkl'), 'wb') as f:
